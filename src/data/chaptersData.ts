  ...
  const dict: Record<SupportedLanguage, Record<number, Partial<ChapterMeta>>> = {
    ...
    ru: {
      1: {
        ...
        tasks: [
          { id: 'c1_harvest', label: 'Выкуп Второй десятины', instruction: 'Решите задачи на выкуп Второй десятины и добавление пятой части!' },
          { id: 'c1_scroll', label: 'Викторина о жертвах', instruction: 'Ответьте на вопросы галахи для свитка жертв паломничества!' },
          { id: 'c1_pack', label: 'Сбор рюкзака', instruction: 'Ответьте на законы чистоты и упакуйте снаряжение в дорогу!' }
        ]
      },
      2: {
        ...
        tasks: [
          { id: 'c2_song', label: 'Песни восхождения', instruction: 'Нажимайте в ритм, чтобы петь "Шир ха-Маалот" с караваном паломников!' },
          { id: 'c2_hospitality', label: 'Гостеприимство', instruction: 'Помогите семье на дороге — поделитесь водой и хлебом из рюкзака!' },
          { id: 'c2_overlook', label: 'Обзор горы Скопус', instruction: 'Вы достигли горы Скопус! Ответьте на вопрос алахи перед стенами Иерусалима.' }
        ]
      },
      3: {
        ...
        tasks: [
          { id: 'c3_market', label: 'Покупка жертвы', instruction: 'Используйте монеты десятины, чтобы купить ягненка и оливковое масло на рынке!' },
          { id: 'c3_inspection', label: 'Проверка изъянов', instruction: 'Используйте лупу для проверки ушей и ног ягненка на отсутствие изъянов!' },
          { id: 'c3_mikveh', label: 'Омовение в микве', instruction: 'Спуститесь по каменным ступеням в микву и нажмите 3 раза для полного очищения!' }
        ]
      },
      4: {
        ...
        tasks: [
          { id: 'c4_wood', label: 'Палата дров', instruction: 'Проверьте бревна и отделите чистые дрова без червей для алтаря!' },
          { id: 'c4_oil', label: 'Палата масел', instruction: 'Нажимайте на маслодавильню в правильном ритме, чтобы выжать чистое масло!' }
        ]
      },
      5: {
        ...
        tasks: [
          { id: 'c5_orchestra', label: 'Оркестр левитов', instruction: 'Играйте вместе с левитами! Нажимайте на арфу, кимвалы и трубы в ритм музыки.' },
          { id: 'c5_altar_logs', label: 'Дровяной костер', instruction: 'Перетащите чистые бревна и постройте большой костер на Алтаре!' }
        ]
      },
      6: {
        ...
        tasks: [
          { id: 'c6_semichah', label: 'Заповедь Семихи', instruction: 'Нажмите и удерживайте руки на голове ягненка с сердечным намерением.' },
          { id: 'c6_priest_service', label: 'Служение священников', instruction: 'Наблюдайте за служением коэнов: кроплением кровью и сожжением.' },
          { id: 'c6_celebration', label: 'Великая праздничная радость', instruction: 'Нажмите, чтобы начать празднование Симхат ха-Хаг и пир в Иерусалиме!' }
        ]
      }
    },
    es: {
